...
let inputField = document.getElementById("teamInput");
inputField.addEventListener("keydown", function (e) {

    if (e.key === "Enter") {
        console.log(inputField.value);
        let team = inputField.value;
        e.target.value = "";

        if (nbaTeams.won.hasOwnProperty(team)) {
            console.log("They have won")
            addTeamToTable(team, document.getElementById("wonTableBody"), true)
        }

        else if (nbaTeams.neverWon.includes(team)) {
            console.log("They have never won")
            addTeamToTable(team, document.getElementById("neverWonTableBody"), false)
        }
...
function addTeamToTable(team, element, hasWon) {
    console.log(`Adding ${team} to ${element}`);
